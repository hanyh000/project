...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'dqn_custom_agent = turtlebot3_dqn.dqn_custom_agent:main',
            'dqn_environment = turtlebot3_dqn.dqn_environment:main',
            'dqn_custom_environment = turtlebot3_dqn.dqn_custom_environment:main',
            'dqn_gazebo = turtlebot3_dqn.dqn_gazebo:main',
            'dqn_custom_gazebo = turtlebot3_dqn.dqn_custom_gazebo:main',
            'dqn_test = turtlebot3_dqn.dqn_test:main',
            'result_graph = turtlebot3_dqn.result_graph:main',
            'dqn_custom_test = turtlebot3_dqn.dqn_custom_test:main',
            'yolo_test = turtlebot3_dqn.yolo_test:main',
        ],
    },
)
